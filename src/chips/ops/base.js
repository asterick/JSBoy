...
jsboyCPU.prototype.stepBase = function(){
    ...
    case 0x18:
        ...
        break ;
    case 0x20:
        var o = this.nextRelative(); if(!this.zf) { this.pc = o; this.cycles += 3; } else this.cycles += 2;
        break ;
    case 0x28:
        var o = this.nextRelative(); if(this.zf) { this.pc = o; this.cycles += 3; } else this.cycles += 2;
        break ;
    case 0x30:
        var o = this.nextRelative(); if(!this.cf) { this.pc = o; this.cycles += 3; } else this.cycles += 2;
        break ;
    case 0x38:
        var o = this.nextRelative(); if(this.cf) { this.pc = o; this.cycles += 3; } else this.cycles += 2;
        break ;
    case 0xC3:
        ...
        break ;
    case 0xC2:
        var o = this.nextWord(); if(!this.zf) { this.pc = o; this.cycles += 4; } else this.cycles += 3;
        break ;
    case 0xCA:
        var o = this.nextWord(); if(this.zf) { this.pc = o; this.cycles += 4; } else this.cycles += 3;
        break ;
    case 0xD2:
        var o = this.nextWord(); if(!this.cf) { this.pc = o; this.cycles += 4; } else this.cycles += 3;
        break ;
    case 0xDA:
        var o = this.nextWord(); if(this.cf) { this.pc = o; this.cycles += 4; } else this.cycles += 3;
        break ;
    ...
    case 0xCD:
        ...
        break ;
    case 0xC4:
        var o = this.nextWord(); if(!this.zf) { this.call(o); this.cycles += 6; } else this.cycles += 3;
        break ;
    case 0xCC:
        var o = this.nextWord(); if(this.zf) { this.call(o); this.cycles += 6; } else this.cycles += 3;
        break ;
    case 0xD4:
        var o = this.nextWord(); if(!this.cf) { this.call(o); this.cycles += 6; } else this.cycles += 3;
        break ;
    case 0xDC:
        var o = this.nextWord(); if(this.cf) { this.call(o); this.cycles += 6; } else this.cycles += 3;
        break ;
    ...
    case 0xD9:
        ...
        break ;
    case 0xC0:
        if(!this.zf) { this.ret(); this.cycles += 5; } else this.cycles += 2;
        break ;
    case 0xC8:
        if(this.zf) { this.ret(); this.cycles += 5; } else this.cycles += 2;
        break ;
    case 0xD0:
        if(!this.cf) { this.ret(); this.cycles += 5; } else this.cycles += 2;
        break ;
    case 0xD8:
        if(this.cf) { this.ret(); this.cycles += 5; } else this.cycles += 2;
        break ;
