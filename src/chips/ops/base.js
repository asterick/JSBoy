define([
    ...
    CPU.prototype.stepBase = function(){
        ...
        case 0xC3:
            ...
            return 4;
        case 0xC2:
            var o = this.nextWord(); if(!this.zf) { this.pc = o; return 4; } else return 3;
        case 0xCA:
            var o = this.nextWord(); if(this.zf) { this.pc = o; return 4; } else return 3;
        case 0xD2:
        ...
        case 0xCD:
            ...
            return 6;
        case 0xC4:
            var o = this.nextWord(); if(!this.zf) { this.call(o); return 6; } else return 3;
        case 0xCC:
            var o = this.nextWord(); if(this.zf) { this.call(o); return 6; } else return 3;
        case 0xD4:
            var o = this.nextWord(); if(!this.cf) { this.call(o); return 6; } else return 3;
        case 0xDC:
            var o = this.nextWord(); if(this.cf) { this.call(o); return 6; } else return 3;
