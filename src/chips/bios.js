function jsboyBIOS( cpu )
{
    this.cpu = cpu;
}

jsboyBIOS.prototype.reset = function()
{
    ...
    this.cpu.write[REG_BLCK] = this.$('write_BLCK');
}

jsboyBIOS.prototype.write_BLCK = function(data)
{    
    if( data != 0x11 )
        return ;
...
jsboyBIOS.prototype.COLOR_BIOS = romBlock([
