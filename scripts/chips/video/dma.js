...
jsboyDMA.prototype.reset = function()
{
    ...
    this.cpu.read[REG_HDMA1] = this.$('read_HDMA1');
    this.cpu.write[REG_HDMA1] = this.$('write_HDMA1');
    this.cpu.read[REG_HDMA2] = this.$('read_HDMA2');
    this.cpu.write[REG_HDMA2] = this.$('write_HDMA2');
    this.cpu.read[REG_HDMA3] = this.$('read_HDMA3');
    this.cpu.write[REG_HDMA3] = this.$('write_HDMA3');
    this.cpu.read[REG_HDMA4] = this.$('read_HDMA4');
    this.cpu.write[REG_HDMA4] = this.$('write_HDMA4');
    this.cpu.read[REG_HDMA5] = this.$('read_HDMA5');
    this.cpu.write[REG_HDMA5] = this.$('write_HDMA5');
}
